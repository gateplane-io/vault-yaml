...
module "setup" {
  ...
  version = "0.4.0"
  # source = "github.com/gateplane-io/terraform-gateplane-setup?ref=main"

  # https://github.com/gateplane-io/vault-plugins/releases/tag/2025.10.19-release
  policy_gate_plugin = {
  ...
  # url_origins = [
  #   "https://vault.testing.security.grnet.gr",
